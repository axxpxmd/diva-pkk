        ...
        <div id="jns_hatinya_pkk_display" style="display: none">
            <div class="row">
                ...
                <div class="col-sm-3 m-t-6">
                    <input type="checkbox" name="jns_hatinya_pkk[]" id="peternakan" value="Peternakan" class="form-check-input add-required-form3">
                    <label class="form-check-label m-l-10">
                        Peternakan
                    </label>
                </div>
                <div class="col-sm-3 m-t-6" id="peternakan_komoditi_display" style="display: none">
                    <input type="text" name="peternakan_komoditi" id="peternakan_komoditi" placeholder="Komoditi" class="form-control add-required-form3" autocomplete="off">
                </div>
                <div class="col-sm-2 m-t-6" id="peternakan_kuantitas_display" style="display: none">
                    <input type="number" name="peternakan_kuantitas" id="peternakan_kuantitas" placeholder="Kuantitas" class="form-control add-required-form3" autocomplete="off">
                </div>
            </div>
            <div class="row">
                <div class="col-sm-4"></div>
                <div class="col-sm-3 m-t-6">
                    <input type="checkbox" name="jns_hatinya_pkk[]" id="perikanan" value="Perikanan" class="form-check-input add-required-form3">
                    <label class="form-check-label m-l-10">
                        Perikanan
                    </label>
                </div>
                <div class="col-sm-3 m-t-6" id="perikanan_komoditi_display" style="display: none">
                    <input type="text" name="perikanan_komoditi" id="perikanan_komoditi" placeholder="Komoditi" class="form-control add-required-form3" autocomplete="off">
                </div>
                <div class="col-sm-2 m-t-6" id="perikanan_kuantitas_display" style="display: none">
                    <input type="number" name="perikanan_kuantitas" id="perikanan_kuantitas" placeholder="Kuantitas" class="form-control add-required-form3" autocomplete="off">
                </div>
            </div>
            <div class="row">
                <div class="col-sm-4"></div>
                <div class="col-sm-3 m-t-6">
                    <input type="checkbox" name="jns_hatinya_pkk[]" id="warung_hidup" value="Warung Hidup" class="form-check-input add-required-form3">
                    <label class="form-check-label m-l-10">
                        Warung Hidup
                    </label>
                </div>
                <div class="col-sm-3 m-t-6" id="warung_hidup_komoditi_display" style="display: none">
                    <input type="text" name="warung_hidup_komoditi" id="warung_hidup_komoditi" placeholder="Komoditi" class="form-control add-required-form3" autocomplete="off">
                </div>
                <div class="col-sm-2 m-t-6" id="warung_hidup_kuantitas_display" style="display: none">
                    <input type="number" name="warung_hidup_kuantitas" id="warung_hidup_kuantitas" placeholder="Kuantitas" class="form-control add-required-form3" autocomplete="off">
                </div>
            </div>
            <div class="row">
                <div class="col-sm-4"></div>
                <div class="col-sm-3 m-t-6">
                    <input type="checkbox" name="jns_hatinya_pkk[]" id="toga" value="Toga" class="form-check-input add-required-form3">
                    <label class="form-check-label m-l-10">
                        Toga
                    </label>
                </div>
                <div class="col-sm-3 m-t-6" id="toga_komoditi_display" style="display: none">
                    <input type="text" name="toga_komoditi" id="toga_komoditi" placeholder="Komoditi" class="form-control add-required-form3" autocomplete="off">
                </div>
                <div class="col-sm-2 m-t-6" id="toga_kuantitas_display" style="display: none">
                    <input type="number" name="toga_kuantitas" id="toga_kuantitas" placeholder="Kuantitas" class="form-control add-required-form3" autocomplete="off">
                </div>
            </div>
            <div class="row">
                <div class="col-sm-4"></div>
                <div class="col-sm-3 m-t-6">
                    <input type="checkbox" name="jns_hatinya_pkk[]" id="tanaman_keras" value="Tanaman Keras" class="form-check-input add-required-form3">
                    <label class="form-check-label m-l-10">
                        Tanaman Keras
                    </label>
                </div>
                <div class="col-sm-3 m-t-6" id="tanaman_keras_komoditi_display" style="display: none">
                    <input type="text" name="tanaman_keras_komoditi" id="tanaman_keras_komoditi" placeholder="Komoditi" class="form-control add-required-form3" autocomplete="off">
                </div>
                <div class="col-sm-2 m-t-6" id="tanaman_keras_kuantitas_display" style="display: none">
                    <input type="number" name="tanaman_keras_kuantitas" id="tanaman_keras_kuantitas" placeholder="Kuantitas" class="form-control add-required-form3" autocomplete="off">
                </div>
            </div>
            <div class="row">
                <div class="col-sm-4"></div>
                <div class="col-sm-3 m-t-6">
                    <input type="checkbox" name="jns_hatinya_pkk[]" id="lainnya" value="Lainnya" class="form-check-input add-required-form3">
                    <label class="form-check-label m-l-10">
                        Lainnya
                    </label>
                </div>
                <div class="col-sm-3 m-t-6" id="lainnya_komoditi_display" style="display: none">
                    <input type="text" name="lainnya_komoditi" id="lainnya_komoditi" placeholder="Komoditi" class="form-control add-required-form3" autocomplete="off">
                </div>
                <div class="col-sm-2 m-t-6" id="lainnya_kuantitas_display" style="display: none">
                    <input type="number" name="lainnya_kuantitas" id="lainnya_kuantitas" placeholder="Kuantitas" class="form-control add-required-form3" autocomplete="off">
                </div>
            </div>
        </div>
    </div>
    <div class="col-sm-6">
        ...
        <div id="jns_industri_rmh_up2k_display" style="display: none">
            <div class="row">
                <div class="col-sm-4"></div>
                <div class="col-sm-3 m-t-6">
                    <input type="checkbox" name="jns_industri_rmh_up2k[]" id="pangan" value="Pangan" class="form-check-input add-required-form3">
                    <label class="form-check-label m-l-10">
                        Pangan
                    </label>
                </div>
                <div class="col-sm-3 m-t-6" id="pangan_komoditi_display" style="display: none">
                    <input type="text" name="pangan_komoditi" id="pangan_komoditi" placeholder="Komoditi" class="form-control add-required-form3" autocomplete="off">
                </div>
                <div class="col-sm-2 m-t-6" id="pangan_kuantitas_display" style="display: none">
                    <input type="number" name="pangan_kuantitas" id="pangan_kuantitas" placeholder="Kuantitas" class="form-control add-required-form3" autocomplete="off">
                </div>
            </div>
            <div class="row">
                <div class="col-sm-4"></div>
                <div class="col-sm-3 m-t-6">
                    <input type="checkbox" name="jns_industri_rmh_up2k[]" id="sandang" value="Sandang" class="form-check-input add-required-form3">
                    <label class="form-check-label m-l-10">
                        Sandang
                    </label>
                </div>
                <div class="col-sm-3 m-t-6" id="sandang_komoditi_display" style="display: none">
                    <input type="text" name="sandang_komoditi" id="sandang_komoditi" placeholder="Komoditi" class="form-control add-required-form3" autocomplete="off">
                </div>
                <div class="col-sm-2 m-t-6" id="sandang_kuantitas_display" style="display: none">
                    <input type="number" name="sandang_kuantitas" id="sandang_kuantitas" placeholder="Kuantitas" class="form-control add-required-form3" autocomplete="off">
                </div>
            </div>
            <div class="row">
                <div class="col-sm-4"></div>
                <div class="col-sm-3 m-t-6">
                    <input type="checkbox" name="jns_industri_rmh_up2k[]" id="konveksi" value="Konveksi" class="form-check-input add-required-form3">
                    <label class="form-check-label m-l-10">
                        Konveksi
                    </label>
                </div>
                <div class="col-sm-3 m-t-6" id="konveksi_komoditi_display" style="display: none">
                    <input type="text" name="konveksi_komoditi" id="konveksi_komoditi" placeholder="Komoditi" class="form-control add-required-form3" autocomplete="off">
                </div>
                <div class="col-sm-2 m-t-6" id="konveksi_kuantitas_display" style="display: none">
                    <input type="number" name="konveksi_kuantitas" id="konveksi_kuantitas" placeholder="Kuantitas" class="form-control add-required-form3" autocomplete="off">
                </div>
            </div>
            <div class="row">
                <div class="col-sm-4"></div>
                <div class="col-sm-3 m-t-6">
                    <input type="checkbox" name="jns_industri_rmh_up2k[]" id="jasa" value="Jasa" class="form-check-input add-required-form3">
                    <label class="form-check-label m-l-10">
                        Jasa
                    </label>
                </div>
                <div class="col-sm-3 m-t-6" id="jasa_komoditi_display" style="display: none">
                    <input type="text" name="jasa_komoditi" id="jasa_komoditi" placeholder="Komoditi" class="form-control add-required-form3" autocomplete="off">
                </div>
                <div class="col-sm-2 m-t-6" id="jasa_kuantitas_display" style="display: none">
                    <input type="number" name="jasa_kuantitas" id="jasa_kuantitas" placeholder="Kuantitas" class="form-control add-required-form3" autocomplete="off">
                </div>
            </div>
            <div class="row">
                <div class="col-sm-4"></div>
                <div class="col-sm-3 m-t-6">
                    <input type="checkbox" name="jns_industri_rmh_up2k[]" id="lainnya_up2k" value="Lainnya" class="form-check-input add-required-form3">
                    <label class="form-check-label m-l-10">
                        Lainnya
                    </label>
                </div>
                <div class="col-sm-3 m-t-6" id="lainnya_up2k_komoditi_display" style="display: none">
                    <input type="text" name="lainnya_up2k_komoditi" id="lainnya_up2k_komoditi" placeholder="Komoditi" class="form-control add-required-form3" autocomplete="off">
                </div>
                <div class="col-sm-2 m-t-6" id="lainnya_up2k_kuantitas_display" style="display: none">
                    <input type="number" name="lainnya_up2k_kuantitas" id="lainnya_up2k_kuantitas" placeholder="Kuantitas" class="form-control add-required-form3" autocomplete="off">
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row mt-2">
            ...
            <div class="col-sm-8">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <button type="button" class="btn btn-block btn-info fs-14" id="btnForm3Next"><i class="bi bi-save m-r-8"></i>Simpan</button>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    // Peternakan
    $('#peternakan').click(function() {
        if ($('#peternakan').is(":checked")){
            $('#peternakan_komoditi_display,#peternakan_kuantitas_display').show();
            $("#peternakan_komoditi,#peternakan_kuantitas").prop('required',true);
        }else{
            $('#peternakan_komoditi_display,#peternakan_kuantitas_display').hide();
            $("#peternakan_komoditi,#peternakan_kuantitas").prop('required',false);
            $("#peternakan_komoditi,#peternakan_kuantitas").val(null);
        }
    });
    // Perikanan
    $('#perikanan').click(function() {
        if ($('#perikanan').is(":checked")){
            $('#perikanan_komoditi_display,#perikanan_kuantitas_display').show();
            $("#perikanan_komoditi,#perikanan_kuantitas").prop('required',true);
        }else{
            $('#perikanan_komoditi_display,#perikanan_kuantitas_display').hide();
            $("#perikanan_komoditi,#perikanan_kuantitas").prop('required',false);
            $("#perikanan_komoditi,#perikanan_kuantitas").val(null);
        }
    });
    // Warung Hidup
    $('#warung_hidup').click(function() {
        if ($('#warung_hidup').is(":checked")){
            $('#warung_hidup_komoditi_display,#warung_hidup_kuantitas_display').show();
            $("#warung_hidup_komoditi,#warung_hidup_kuantitas").prop('required',true);
        }else{
            $('#warung_hidup_komoditi_display,#warung_hidup_kuantitas_display').hide();
            $("#warung_hidup_komoditi,#warung_hidup_kuantitas").prop('required',false);
            $("#warung_hidup_komoditi,#warung_hidup_kuantitas").val(null);
        }
    });
    // Toga
    $('#toga').click(function() {
        if ($('#toga').is(":checked")){
            $('#toga_komoditi_display,#toga_kuantitas_display').show();
            $("#toga_komoditi,#toga_kuantitas").prop('required',true);
        }else{
            $('#toga_komoditi_display,#toga_kuantitas_display').hide();
            $("#toga_komoditi,#toga_kuantitas").prop('required',false);
            $("#toga_komoditi,#toga_kuantitas").val(null);
        }
    });
    // Tanaman Keras
    $('#tanaman_keras').click(function() {
        if ($('#tanaman_keras').is(":checked")){
            $('#tanaman_keras_komoditi_display,#tanaman_keras_kuantitas_display').show();
            $("#tanaman_keras_komoditi,#tanaman_keras_kuantitas").prop('required',true);
        }else{
            $('#tanaman_keras_komoditi_display,#tanaman_keras_kuantitas_display').hide();
            $("#tanaman_keras_komoditi,#tanaman_keras_kuantitas").prop('required',false);
            $("#tanaman_keras_komoditi,#tanaman_keras_kuantitas").val(null);
        }
    });
    // Lainnya
    $('#lainnya').click(function() {
        if ($('#lainnya').is(":checked")){
            $('#lainnya_komoditi_display,#lainnya_kuantitas_display').show();
            $("#lainnya_komoditi,#lainnya_kuantitas").prop('required',true);
        }else{
            $('#lainnya_komoditi_display,#lainnya_kuantitas_display').hide();
            $("#lainnya_komoditi,#lainnya_kuantitas").prop('required',false);
            $("#lainnya_komoditi,#lainnya_kuantitas").val(null);
        }
    });
    ...
    // Pangan
    $('#pangan').click(function() {
        if ($('#pangan').is(":checked")){
            $('#pangan_komoditi_display,#pangan_kuantitas_display').show();
            $("#pangan_komoditi,#pangan_kuantitas").prop('required',true);
        }else{
            $('#pangan_komoditi_display,#pangan_kuantitas_display').hide();
            $("#pangan_komoditi,#pangan_kuantitas").prop('required',false);
            $("#pangan_komoditi,#pangan_kuantitas").val(null);
        }
    });
    // Sandang
    $('#sandang').click(function() {
        if ($('#sandang').is(":checked")){
            $('#sandang_komoditi_display,#sandang_kuantitas_display').show();
            $("#sandang_komoditi,#sandang_kuantitas").prop('required',true);
        }else{
            $('#sandang_komoditi_display,#sandang_kuantitas_display').hide();
            $("#sandang_komoditi,#sandang_kuantitas").prop('required',false);
            $("#sandang_komoditi,#sandang_kuantitas").val(null);
        }
    });
    // Konveksi
    $('#konveksi').click(function() {
        if ($('#konveksi').is(":checked")){
            $('#konveksi_komoditi_display,#konveksi_kuantitas_display').show();
            $("#konveksi_komoditi,#konveksi_kuantitas").prop('required',true);
        }else{
            $('#konveksi_komoditi_display,#konveksi_kuantitas_display').hide();
            $("#konveksi_komoditi,#konveksi_kuantitas").prop('required',false);
            $("#konveksi_komoditi,#konveksi_kuantitas").val(null);
        }
    });
    // Jasa
    $('#jasa').click(function() {
        if ($('#jasa').is(":checked")){
            $('#jasa_komoditi_display,#jasa_kuantitas_display').show();
            $("#jasa_komoditi,#jasa_kuantitas").prop('required',true);
        }else{
            $('#jasa_komoditi_display,#jasa_kuantitas_display').hide();
            $("#jasa_komoditi,#jasa_kuantitas").prop('required',false);
            $("#jasa_komoditi,#jasa_kuantitas").val(null);
        }
    });
    // Lainnya UP2K
    $('#lainnya_up2k').click(function() {
        if ($('#lainnya_up2k').is(":checked")){
            $('#lainnya_up2k_komoditi_display,#lainnya_up2k_kuantitas_display').show();
            $("#lainnya_up2k_komoditi,#lainnya_up2k_kuantitas").prop('required',true);
        }else{
            $('#lainnya_up2k_komoditi_display,#lainnya_up2k_kuantitas_display').hide();
            $("#lainnya_up2k_komoditi,#lainnya_up2k_kuantitas").prop('required',false);
            $("#lainnya_up2k_komoditi,#lainnya_up2k_kuantitas").val(null);
        }
    });
