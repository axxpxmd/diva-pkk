...
<script type="text/javascript">
    var table = $('#dataTable').dataTable({
        ...
        columns: [
            ...
            {data: 'nama', name: 'nama'},
            {data: 'nik', name: 'nik'},
            {data: 'kelamin', name: 'kelamin', className: 'text-center'},
            {data: 'agama', name: 'agama', className: 'text-center'},
            {data: 'domisili', name: 'domisili', className: 'text-center'},
            {data: 'status_kawin', name: 'status_kawin', className: 'text-center'},
