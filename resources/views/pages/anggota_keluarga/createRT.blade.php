...
<section class="section animate__animated animate__fadeInRight">
    ...
    <div class="card">
        <h5 class="card-header bg-info text-white mb-2 p-3 fs-18">Tambah Warga </h5>
        <div class="card-body">
            <div id="alert"></div>
                ...
                <div class="row mt-2">
                    <div class="col-sm-6">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control select2" name="dasawisma_id" id="dasawisma_id" disabled>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="row mt-2">
                            <div class="col-sm-4"></div>
                            <div class="col-sm-8">
                                <button type="submit" class="btn btn-block btn-success fs-14" id="btnForm1Next"><i class="bi bi-save m-r-8"></i>Simpan</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $('#form').on('submit', function (event) {
        if ($(this)[0].checkValidity() === false) {
            ...
            url = "{{ route('anggota-keluarga.storeRT') }}";
