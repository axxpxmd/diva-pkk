    ...
    <div class="sidebar-wrapper shadow active">
        ...
        <div class="sidebar-menu">
            <ul class="menu mt-3">
                ...
                <br>
                <span class="fs-14 fw-bold">Role : {{ Auth::user()->modelHasRole->role->name }}</span>
                <hr class="mt-1 mb-3">
                ...
                <!-- Menu -->
                @canany(['rt/rw', 'dasawisma', 'kader', 'rumah', 'anggota kk', 'kelurahan'])
                ...
                @can('anggota kk')
                    <li class="sidebar-item {{ isset($active_anggota) ? 'active' : '-' }}">
                        <a href="{{ route('anggota-keluarga.index') }}" class='sidebar-link'>
